...
describe('Valido la ruta recibida, según ello retornará o no la información y los estados de los links de los archivos Markdown.', () => {
  ...
  it('Si es un archivo cuya ruta es válida y validate es "false", debería retornar un array de objetos con las propiedades: href, text y file.',
  ...
  it('Si es un archivo cuya ruta es válida y validate es "true", debería retornar un array de objetos con las propiedades: href, text, file, status y statusText.',
  ...
  it('Si es un directorio cuya ruta es válida y validate es "false", debería retornar un array de objetos con las propiedades: href, text y file.',
  ...
  it('Si es un directorio cuya ruta es válida y validate es "true", debería retornar un array de objetos con las propiedades: href, text, file, status y statusText.',
